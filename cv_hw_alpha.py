...
def StitchAndBlend(image1, image2):
    ...
    if len(matches) > 4:
        ...
        for _ in range(80):
        # mask_blured = cv2.GaussianBlur(mask_blured, (5,5), 10000)
        ...
        # mask2 = cv2.multiply(1-mask_blured, mask_hed)
...
image1 = cv2.imread('./right3.png')
cv_show("image1", image1)
image2 = cv2.imread('./left1.jpg')
...
cv2.imwrite('./result/matched_img.jpg', matchedimg)
result = result*255
